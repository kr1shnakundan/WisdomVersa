...
export const addCourseDetails = async(data,token) =>{
    ...
    try{
        ...
        console.log("ERROR in ADDCOURSEDETAILS API : ",error)
        toast.error("Unable to add course details")
    }
    toast.dismiss(toastId)
    return result
}
...
export const editCourseDetails = async(data,token)=>{
    ...
    try{
        console.log("DATA IN EDITCOURSEAPI : ",data)
        ...
        console.log("response from editCourseDetails API : ",response)

        toast.success("Course Edited Successfully")
        result = response?.data?.data
    } catch(error){
        console.log("ERROR IN EDITCOURSEAPI : ",error)
        toast.error("unable to editCourse")
    }
    toast.dismiss(toastId)
    return result
}
